...
def copy_and_clean_file(src_path: str, dest_path: str, comment_base: str):
    try:
        ...
        print(f"✅ Copied and cleaned {os.path.basename(dest_path)}")
...
def flatten_from_file():
    ...
    for line in lines:
        full_path = os.path.abspath(line if os.path.isabs(line) else os.path.join(SRC_DIR, line))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--docs', action='store_true', help="Flatten all .md files from root-level docs/")
